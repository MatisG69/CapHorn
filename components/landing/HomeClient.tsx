...
const METHOD_STEPS = [
  { n: '01', name: 'Qualifiez votre projet', desc: 'Notre outil préqualifie votre projet en moins de trois minutes. Aucun document n’est nécessaire à cette étape.', src: '/methode/qualification-projet-financement.webp' },
  { n: '02', name: 'Échange personnalisé', desc: 'Un expert vous rappelle sous 24 h afin d’affiner votre projet et de définir la stratégie de financement la plus adaptée.', src: '/methode/echange-conseiller-financement.webp' },
  { n: '03', name: 'Montage & négociation', desc: 'Nous constituons votre dossier et négocions chaque paramètre auprès des établissements les plus adaptés à votre projet.', src: '/methode/montage-dossier-negociation-bancaire.webp' },
  { n: '04', name: 'Signature & suivi', desc: 'Nous coordonnons chaque étape jusqu’à la signature et sécurisons les conditions qui protégeront durablement vos intérêts.', src: '/methode/signature-financement-accompagnement.webp' },
]
    ...
    <div className="chc">
      ...
      <div id="contact">
        <SectionWithMockup
          ...
          contact="Lille & Hauts-de-France · financezmonprojet.fr"
          primaryImageSrc="/methode/echange-conseiller-financement.webp"
          secondaryImageSrc="/methode/etude-dossier-financement-credit.webp"
        />
      </div>
